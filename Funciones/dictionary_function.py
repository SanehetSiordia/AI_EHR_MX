...
#            'Biomedical_Cased_CBOW_inicial':None,
#            'Biomedical_Cased_CBOW_final': None,
#            'Biomedical_Cased_SKIPGRAM_inicial': None,
#            'Biomedical_Cased_SKIPGRAM_final': None,
#            'Biomedical_Uncased_CBOW_inicial':None,
#            'Biomedical_Uncased_CBOW_final': None,
#            'Biomedical_Uncased_SKIPGRAM_inicial': None,
#            'Biomedical_Uncased_SKIPGRAM_final': None,
#            'Clinic_Cased_CBOW_inicial':None,
#            'Clinic_Cased_CBOW_final': None,
#            'Clinic_Cased_SKIPGRAM_inicial': None,
#            'Clinic_Cased_SKIPGRAM_final': None}
